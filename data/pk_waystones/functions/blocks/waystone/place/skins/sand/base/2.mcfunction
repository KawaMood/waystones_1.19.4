#> pk_waystones:blocks/waystone/place/skins/sand/base/2
...
# Set data
data merge entity @s {item:{id:"minecraft:cut_sandstone_slab",Count:1b},transformation:{scale:[1f,1f,1f],translation:[0.5f,0.5f,0.5f]}}