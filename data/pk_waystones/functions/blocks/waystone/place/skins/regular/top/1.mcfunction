#> pk_waystones:blocks/waystone/place/skins/regular/top/1
...
# Set data
data merge entity @s {item:{id:"minecraft:polished_andesite_slab",Count:1b},transformation:{scale:[0.9375f,0.9375f,0.9375f],translation:[0.5f,0.1770f,0.5f]}}
