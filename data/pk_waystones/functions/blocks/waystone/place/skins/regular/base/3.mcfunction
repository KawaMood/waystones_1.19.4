#> pk_waystones:blocks/waystone/place/skins/regular/base/3
...
# Set data
data merge entity @s {item:{id:"minecraft:polished_andesite_slab",Count:1b},transformation:{scale:[0.9375f,0.9375f,0.9375f],translation:[0.5f,1.235f,0.5f]}}