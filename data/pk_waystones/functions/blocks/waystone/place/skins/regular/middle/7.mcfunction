#> pk_waystones:blocks/waystone/place/skins/regular/middle/7
...
# Set data 
data merge entity @s {item:{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;16,11,1,0],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvODUyYTMxMTE0MDE0NTQxMmM2YjdlNjRkZTY1NDEyODMxMmJhNmRhODk0MTI0ZDE1Y2Q2MmMwMTI2NWE1ZjgzNSJ9fX0="}]}}}},transformation:{translation:[0.7505f,2.0005f,0.7505f],scale:[1.002f,1.002f,1.002f]}}