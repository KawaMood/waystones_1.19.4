#> pk_waystones:blocks/waystone/place/skins/nether/base/1
...
# Set data
data merge entity @s {item:{id:"minecraft:nether_bricks",Count:1b},transformation:{scale:[0.6875f,0.6875f,0.6875f],translation:[0.5f,0.755f,0.5f]}}