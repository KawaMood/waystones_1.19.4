#> pk_waystones:blocks/waystone/place/skins/nether/base/2
...
# Set data
data merge entity @s {item:{id:"minecraft:nether_brick_slab",Count:1b},transformation:{scale:[1f,1f,1f],translation:[0.5f,0.5f,0.5f]}}