#> pk_waystones:blocks/waystone/place/skins/nether/middle/legacy
...
tag @s add pk.part.middle.legacy

# Set data 
data merge entity @s {item:{id:"minecraft:chiseled_nether_bricks",Count:1b},transformation:{translation:[0.4995f,1.4995f,0.4995f],scale:[1.002f,1.002f,1.002f]}}